...
\begin{itemize}
    ...
    \item Suppose $P(k): 1^3+2^3+...+k^3 = \Biggr[ \dfrac{k(k+1)}{2} \Biggl] ^2$
    \item Observe $\Biggr[ \dfrac{k(k+1)}{2} \Biggl] ^2 = \Biggr[ \dfrac{k^4+2k^3+k^2}{2} \Biggl]$
    \item Observe $\Biggr[ \dfrac{(k+1)^4+2(k+1)^3+(k+1)^2}{2} \Biggl] = \Biggr[ \dfrac{k^4+6k^3+13k^2+12k+4}{2} \Biggl]$
    \item Add $(k+1)^3$ to both sides of $1^3+2^3+...+k^3 = \Biggr[ \dfrac{k(k+1)}{2} \Biggl] ^2$
    \item This yields $1^3+2^3+...+k^3 + (k+1)^3 = \Biggr[ \dfrac{k(k+1)}{2} \Biggl] ^2 + (k+1)^3$
    \item Observe $(k+1)^3 = k^3+3k^2+3k+1 = \dfrac{4k^3+12k^2+12k+4}{2}$
    \item Subsituting $1^3+2^3+...+k^3 + (k+1)^3 = \Biggr[ \dfrac{k(k+1)}{2} \Biggl] ^2 + \dfrac{4k^3+12k^2+12k+4}{2}$
    \item Subsituting $1^3+2^3+...+k^3 + (k+1)^3 = \Biggr[ \dfrac{k^4+2k^3+k^2}{2} \Biggl] + \dfrac{4k^3+12k^2+12k+4}{2}$
    \item Simplify $1^3+2^3+...+k^3 + (k+1)^3 = \Biggr[ \dfrac{k^4+6k^3+13k^2+4}{2} \Biggl]$
...
\begin{itemize}
    ...
    \item Suppose $P(k): 1+4+7+...+(3k-2) = \dfrac{3k^2-k}{2}$
...
\begin{itemize}
    ...
    \item Suppose $P(k):(k^3+5k) \implies \exists c \in \mathbb{N} \ni 6c=k^3+5k$
